    ...
    <div>
      ...
      <div className="mt-4 py-4 px-6 md:px-16 lg:px-24 xl:px-40">
        ...
        <div className="flex gap-5">
          <Card className="w-full md:w-55 md:h-40 rounded-md flex flex-col items-center justify-center gap-2  cursor-pointer hover:shadow-md  bg-linear-to-tr from-blue-100/10 to-indigo-300 hover:to-indigo-400 dark:from-indigo-900/40 dark:to-indigo-800 hover:dark:to-indigo-700 transition-colors duration-200">
