...
const Testimonial = () => {
  ...
  const CreateCard = ({ card }: CardProps) => (
    <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 border border-muted">
    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 text-sm text-indigo-600 bg-indigo-400/10 border border-indigo-200 rounded-full px-6 py-1.5">
          <BookUserIcon className="stroke-indigo-600 size-4.5" />
